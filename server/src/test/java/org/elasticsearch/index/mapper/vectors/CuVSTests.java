...
@LuceneTestCase.SuppressSysoutChecks(bugUrl = "cuVS library itself prints to stdout")
public class CuVSTests extends LuceneTestCase {

    protected static Logger log = Logger.getLogger(CuVSTests.class.getName());
